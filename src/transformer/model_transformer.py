...
from util import TransformerWithToken

class SlideDeckEncoder(nn.Module):
    def __init__(self, num_label, d_model=512, nhead=8, num_layers=4):
        super(SlideDeckEncoder).__init__()
    def forward(self, label, padding_mask):
        return label
